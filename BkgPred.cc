...
int main(){
  ...
  TH2F* tt_1b_2mu_c1 = new TH2F(*tt_1b_2mu);//ttbar MC 2mu1b
  TH2F* tt_1b_2mu_c2 = new TH2F(*tt_1b_2mu);//ttbar MC 2mu1b
  TH2F* data_1b_2mu_copy1 = new TH2F(*data_1b_2mu);//Data 2mu1b
  ...
  //////////////Prediction 0mu1b//////////////////////
  tt_1b_0mu->Divide(tt_1b_2mu_c2);//ttbar Ratio 0mu1b/2mu1b
  
  data_1b_2mu->Multiply(tt_0b_2mu);//Prediction in the 2mu0b
  
  data_1b_2mu_copy1->Multiply(tt_1b_1mu);//Prediction in the 1mu1b
  data_1b_2mu_copy2->Multiply(tt_1b_0mu);//Prediction in the 0mu1b
  ...
  std::cout << "================1mu1b int and error=====================: " << Integral << " " << error << std::endl;
  Integral = data_1b_2mu_copy2->IntegralAndError(1, 6, 1, 6, error, "");
  std::cout << "================0m1b int and error=====================: " << Integral << " " << error << std::endl;
  ...
  //RatioPlotsBand( data_0b_2mu_MR, pred_MR, "t#bar{t} MC 2-#mu BOX", "t#bar{t} Pred 2-#mu BOX", "PredPlots/tt_MR_2mu_pred", "MR");
  //RatioPlotsBand( data_0b_2mu_R2, pred_R2, "t#bar{t} MC 2-#mu BOX", "t#bar{t} Pred 2-#mu BOX", "PredPlots/tt_R2_2mu_Pred", "RSQ");
  
  RatioPlotsBand( tt_1b_1mu_MR, pred_MR_1mu, "t#bar{t} MC 1-#mu BOX", "t#bar{t} Pred 1-#mu BOX", "PredPlots/tt_MR_1mu_1b_pred", "MR");
  RatioPlotsBand( tt_1b_1mu_R2, pred_R2_1mu, "t#bar{t} MC 1-#mu BOX", "t#bar{t} Pred 1-#mu BOX", "PredPlots/tt_R2_1mu_1b_Pred", "RSQ");
  
  RatioPlotsBand( tt_1b_0mu_MR, pred_MR_0mu, "t#bar{t} MC 1-#mu BOX", "t#bar{t} Pred 0-#mu BOX", "PredPlots/tt_MR_0mu_1b_pred", "MR");
  RatioPlotsBand( tt_1b_0mu_R2, pred_R2_0mu, "t#bar{t} MC 1-#mu BOX", "t#bar{t} Pred 0-#mu BOX", "PredPlots/tt_R2_0mu_1b_Pred", "RSQ");
