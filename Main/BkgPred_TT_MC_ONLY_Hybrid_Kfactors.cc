...
int main(){
  ...
  std::cout << "===2mu 2b ttbar---> " << tt_1b_2mu_R2->Integral() << std::endl;
  std::cout << "===2mu 2b Data---> " << data_1b_2mu_R2->Integral() << std::endl;
  
  double k_tt = data_1b_2mu_R2->Integral()/tt_1b_2mu_R2->Integral();
  std::cout << "===k_tt ---> " << k_tt << std::endl;
  ...
  p_0b_2mu_dy->Add(tt_0b_2mu, -k_tt);

  double k_zll = p_0b_2mu_dy->Integral()/dy_0b_2mu_R2->Integral();
  std::cout << "===k_zll ---> " << k_zll << std::endl;

  //k_w 

  TH1F* p_w_r2 = new TH1F(*data_0b_1mu_R2);
  p_w_r2->Add(tt_0b_1mu_R2, -k_tt);
  p_w_r2->Add(dy_0b_1mu_R2, -k_zll);

  double k_w = p_w_r2->Integral()/W_0b_1mu_R2->Integral();
  ...
  RatioPlots( dy_0b_1mu_MR, dy_0b_2mu_MR, "Z/#gamma^{*}(ll) MC 1-#mu BOX", "Z/#gamma^{*}(ll) MC 2-#mu BOX", "RatioPlots/dy_MR_1mu_to_2mu", "MR");
  RatioPlots( dy_0b_1mu_R2, dy_0b_2mu_R2, "Z/#gamma^{*}(ll) MC 1-#mu BOX", "Z/#gamma^{*}(ll) MC 2-#mu BOX", "RatioPlots/dy_R2_1mu_to_2mu", "RSQ");

  TH2F* dy_0b_2mu_s = new TH2F(*dy_0b_2mu);
  dy_0b_2mu_s->Sumw2();
  dy_0b_2mu_s->Scale(k_zll);

  TH2F* p_0b_1mu_dy = new TH2F( *data_0b_2mu );//Drell-Yan prediction for 0b 1mu box
  p_0b_1mu_dy->Add(tt_0b_2mu, -k_tt);//Subtracting tt 0b 2mu from MC
  ...
  p_0b_1mu_W->Add(tt_0b_1mu, -k_tt);//Subtraction tt 1mu from MC
  ...
  RatioPlots( dy_0b_0mu_MR, dy_0b_2mu_MR, "Z/#gamma^{*}(ll) MC 0-#mu BOX", "Z/#gamma^{*}(ll) MC 2-#mu BOX", "RatioPlots/dy_MR_0mu_to_2mu", "MR");
  RatioPlots( dy_0b_0mu_R2, dy_0b_2mu_R2, "Z/#gamma^{*}(ll) MC 0-#mu BOX", "Z/#gamma^{*}(ll) MC 2-#mu BOX", "RatioPlots/dy_R2_0mu_to_2mu", "RSQ");
  TH2F* p_0b_0mu_dy = new TH2F( *data_0b_2mu );//Drell-Yan prediction for 0b 0mu box
  p_0b_0mu_dy->Add(tt_0b_2mu, -k_tt);//Subtracting tt 0b 2mu from MC
  ...
  ////////////////////////////////////////
  /////////Z(nunu) 0 mu box from WJets////
  ///////////////////////////////////////
  Z_0b_0mu_MR->Scale(1.0/Z_0b_0mu_MR->Integral());
  Z_0b_0mu_R2->Scale(1.0/Z_0b_0mu_R2->Integral());

  RatioPlots( Z_0b_0mu_MR, dy_0b_2mu_MR, "Z(#nu#nu) MC 0-#mu BOX", "Z/#gamma^{*}(ll) MC 2-#mu BOX", "RatioPlots/Z_MR_0mu_to_DY2mu", "MR");
  RatioPlots( Z_0b_0mu_R2, dy_0b_2mu_R2, "Z(#nu#nu) MC 0-#mu BOX", "Z/#gamma^{*}(ll) MC 2-#mu BOX", "RatioPlots/Z_R2_0mu_to_DY2mu", "RSQ");

  TH2F* p_0b_0mu_Z = new TH2F( *p_0b_1mu_W );//Z(nunu) prediction for 0b 0mu 
  TH2F* r_0b_0mu_Z = new TH2F( *Z_0b_0mu );
  r_0b_0mu_Z->Scale(k_zll);
  TH2F* W_0b_1mu_s = new TH2F(*W_0b_1mu);
  W_0b_1mu_s->Scale(k_w);
  r_0b_0mu_Z->Divide(W_0b_1mu_s);
  p_0b_0mu_Z->Multiply(r_0b_0mu_Z);
  Integral = p_0b_0mu_Z->IntegralAndError(1, 6, 1, 6, error, "");
  std::cout << "---------5)-------" << std::endl;
  std::cout << "Z(nunu) Prediction 0b 0mu box from W: " << Integral << " error: " << error << std::endl;
  TH1F* pred_MR_Z_0b_0mu = (TH1F*)p_0b_0mu_Z->ProjectionX("MR_Z_0mu_0b_pred_W", 0, -1, "eo");
  TH1F* pred_R2_Z_0b_0mu = (TH1F*)p_0b_0mu_Z->ProjectionY("R2_Z_0mu_0b_pred_W", 0, -1, "eo");

  ////////////////////////////////////////
  /////////Z(nunu) 0 mu box from DY//////
  ///////////////////////////////////////
  Z_0b_0mu_MR->Scale(1.0/Z_0b_0mu_MR->Integral());
  Z_0b_0mu_R2->Scale(1.0/Z_0b_0mu_R2->Integral());

  TH2F* p_0b_0mu_Z_v2 = new TH2F( *p_0b_2mu_dy );
  TH2F* r_0b_0mu_Z_v2 = new TH2F( *Z_0b_0mu );
  r_0b_0mu_Z_v2->Divide(dy_0b_2mu);
  p_0b_0mu_Z_v2->Multiply(r_0b_0mu_Z_v2);
  Integral = p_0b_0mu_Z_v2->IntegralAndError(1, 6, 1, 6, error, "");
  std::cout << "---------5.5)-------" << std::endl;
  std::cout << "Z(nunu) Prediction 0b 0mu box from Z(ll): " << Integral << " error: " << error << std::endl;
  TH1F* pred_MR_Z_0b_0mu_v2 = (TH1F*)p_0b_0mu_Z_v2->ProjectionX("MR_Z_0mu_0b_pred_zll", 0, -1, "eo");
  TH1F* pred_R2_Z_0b_0mu_v2 = (TH1F*)p_0b_0mu_Z_v2->ProjectionY("R2_Z_0mu_0b_pred_zll", 0, -1, "eo");
  ...
  RatioPlots( W_0b_0mu_MR, W_0b_1mu_MR, "WJets MC 0-#mu BOX", "WJets MC 1-#mu BOX", "RatioPlots/W_MR_0mu_to_1mu", "MR");
  RatioPlots( W_0b_0mu_R2, W_0b_1mu_R2, "WJets MC 0-#mu BOX" , "WJets MC 1-#mu BOX", "RatioPlots/W_R2_0mu_to_1mu", "RSQ");
  
  RatioPlots( Z_0b_0mu_MR, W_0b_1mu_MR, "Z(#nu#nu) MC 0-#mu BOX", "WJets MC 2-#mu BOX", "RatioPlots/Z_MR_0mu_to_W2mu", "MR");
  RatioPlots( Z_0b_0mu_R2, W_0b_1mu_R2, "Z(#nu#nu) MC 0-#mu BOX", "WJets MC 2-#mu BOX", "RatioPlots/Z_R2_0mu_to_W2mu", "RSQ");
  ...
  bkg->Add(tt_0b_0mu, k_tt);//Adding tt+jets from MC
  ...
  ////////////////////////////////////////////
  ////////Total Prediction 0-mu box zll///////
  ////////////////////////////////////////////
  TH2F* bkg_v2 = new TH2F( *p_0b_0mu_W );//Adding W+jets prediction
  bkg_v2->Add(tt_0b_0mu, k_tt);//Adding tt+jets from MC
  bkg_v2->Add(p_0b_0mu_dy);//Adding Z/gamma*(ll)+jets prediction
  bkg_v2->Add(p_0b_0mu_Z_v2);//Adding Z(nunu)+jets prediction
  Integral = bkg_v2->IntegralAndError(1, 6, 1, 6, error, "");
  std::cout << "---------8)-------" << std::endl;
  std::cout << "==============Total bkg Prediction 0b 0mu box: " << Integral << " error: " << error << "==============" << std::endl;
  Integral = data_0b_0mu->IntegralAndError(1, 6, 1, 6, error, "");
  std::cout << "======= Data Signal Region: " << Integral << " error: " << error << "============" << std::endl;
  
  TH1F* pred_MR_bkg_0b_0mu_v2 = (TH1F*)bkg_v2->ProjectionX("MR_bkg_0mu_0b_pred_v2", 0, -1, "eo");
  TH1F* pred_R2_bkg_0b_0mu_v2 = (TH1F*)bkg_v2->ProjectionY("R2_bkg_0mu_0b_pred_v2", 0, -1, "eo");
  RatioPlotsBand( data_0b_0mu_MR, pred_MR_bkg_0b_0mu_v2, "Data  0-#mu BOX", "Bkg Pred 0-#mu BOX", "PredPlots/Total_Bkg_MR_0mu_0b_pred_v2", "MR");
  RatioPlotsBand( data_0b_0mu_R2, pred_R2_bkg_0b_0mu_v2, "Data  0-#mu BOX", "BKg Pred 0-#mu BOX", "PredPlots/Total_Bkg_R2_0mu_0b_Pred_v2", "RSQ");

  ////////////////////////////////////////////
  ////////Total Prediction 0-mu box from MC scaled///////
  ////////////////////////////////////////////
  TH2F* bkg_v3 = new TH2F( *W_0b_0mu );//Adding W+jets prediction
  bkg_v3->Scale(k_w);
  bkg_v3->Add(tt_0b_0mu, k_tt);//Adding tt+jets from MC
  bkg_v3->Add(dy_0b_0mu, k_zll);//Adding Z/gamma*(ll)+jets prediction
  bkg_v3->Add(Z_0b_0mu, k_zll);//Adding Z(nunu)+jets prediction
  Integral = bkg_v3->IntegralAndError(1, 6, 1, 6, error, "");
  std::cout << "---------8)-------" << std::endl;
  std::cout << "==============Total bkg Prediction 0b 0mu box: " << Integral << " error: " << error << "==============" << std::endl;
  Integral = data_0b_0mu->IntegralAndError(1, 6, 1, 6, error, "");
  std::cout << "======= Data Signal Region: " << Integral << " error: " << error << "============" << std::endl;
  
  TH1F* pred_MR_bkg_0b_0mu_v3 = (TH1F*)bkg_v3->ProjectionX("MR_bkg_0mu_0b_pred_v3", 0, -1, "eo");
  TH1F* pred_R2_bkg_0b_0mu_v3 = (TH1F*)bkg_v3->ProjectionY("R2_bkg_0mu_0b_pred_v3", 0, -1, "eo");
  RatioPlotsBand( data_0b_0mu_MR, pred_MR_bkg_0b_0mu_v3, "Data  0-#mu BOX", "Bkg Pred 0-#mu BOX", "PredPlots/Total_Bkg_MR_0mu_0b_pred_v3", "MR");
  RatioPlotsBand( data_0b_0mu_R2, pred_R2_bkg_0b_0mu_v3, "Data  0-#mu BOX", "BKg Pred 0-#mu BOX", "PredPlots/Total_Bkg_R2_0mu_0b_Pred_v3", "RSQ");
  ...
  RatioPlots( W_0b_1mu_MR, dy_0b_2mu_MR, "WJets MC 1-#mu BOX", "Z/#gamma^{*}(ll) MC 2-#mu BOX", "RatioPlots/W_MR_1mu_to_DY2mu", "MR");
  RatioPlots( W_0b_1mu_R2, dy_0b_2mu_R2, "WJets MC 1-#mu BOX", "Z/#gamma^{*}(ll) MC 2-#mu BOX", "RatioPlots/W_R2_1mu_to_DY2mu", "RSQ");
  ...
  pred_0b_1mu_W->Add(tt_0b_2mu, -0.50234);//Subtracting tt 0b 2mu from MC    
  ...
  Integral = dy_0b_2mu_s->IntegralAndError(1, 6, 1, 6, error, "");
  std::cout << "======= MC Z(ll) 2mu box scaled=======: " << Integral << " error: " << error << "============" << std::endl;
  TH2F* r_0b_1mu_W_closure = new TH2F( *W_0b_1mu );//W+Jets (1Mu-0Btag)
  //r_0b_1mu_W_closure->Scale(1.1959);
  r_0b_1mu_W_closure->Divide(dy_0b_2mu_s);//Z(ll) (2Mu-0Btag)
  ...
  TFile *bkg_file_1DRsq = new TFile("Pred_Files/Bkg_Pred_1D_Rsq_ttMC.root","RECREATE");
  bkg_file_1DRsq->cd();
