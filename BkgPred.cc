...
int main(){
  ...
  RatioPlots( tt_0b_2mu_MR, pred_MR, "t#bar{t} MC 2-#mu BOX", "t#bar{t} Pred 2-#mu BOX", "RatioPlots/tt_MR_2mu_pred", "MR");
  RatioPlots( tt_0b_2mu_R2, pred_R2, "t#bar{t} MC 2-#mu BOX", "t#bar{t} Pred 2-#mu BOX", "RatioPlots/tt_R2_2mu_Pred", "RSQ");
  ...
  RatioPlots( dy_0b_1mu_MR, pred_MR_dy_0b_1mu, "Z/#gamma^{*} MC 1-#mu BOX", "Z/#gamma^{*} Pred 1-#mu BOX", "RatioPlots/dy_MR_1mu_0b_pred", "MR");
  RatioPlots( dy_0b_1mu_R2, pred_R2_dy_0b_1mu, "Z/#gamma^{*} MC 1-#mu BOX", "Z/#gamma^{*} Pred 1-#mu BOX", "RatioPlots/dy_R2_1mu_0b_Pred", "RSQ");
  ...
  RatioPlots( tt_0b_1mu_MR, pred_MR_tt_0b_1mu, "t#bar{t} MC 1-#mu BOX", "t#bar{t} Pred 1-#mu BOX", "RatioPlots/tt_MR_1mu_0b_pred", "MR");
  RatioPlots( tt_0b_1mu_R2, pred_R2_tt_0b_1mu, "t#bat{t} MC 1-#mu BOX", "t#bar{t} Pred 1-#mu BOX", "RatioPlots/tt_R2_1mu_0b_Pred", "RSQ");
  ...
  RatioPlots( W_0b_1mu_MR, pred_MR_W_0b_1mu, "W MC 1-#mu BOX", "W Pred 1-#mu BOX", "RatioPlots/W_MR_1mu_0b_pred_ttMC", "MR");
  RatioPlots( W_0b_1mu_R2, pred_R2_W_0b_1mu, "W MC 1-#mu BOX", "W Pred 1-#mu BOX", "RatioPlots/W_R2_1mu_0b_Pred_ttMC", "RSQ");
  ...
  RatioPlots( dy_0b_0mu_MR, pred_MR_dy_0b_0mu, "Z/#gamma^{*} MC 0-#mu BOX", "Z/#gamma^{*} Pred 0-#mu BOX", "RatioPlots/dy_MR_0mu_0b_pred", "MR");
  RatioPlots( dy_0b_0mu_R2, pred_R2_dy_0b_0mu, "Z/#gamma^{*} MC 0-#mu BOX", "Z/#gamma^{*} Pred 0-#mu BOX", "RatioPlots/dy_R2_0mu_0b_Pred", "RSQ");
  ...
  RatioPlots( tt_0b_0mu_MR, pred_MR_tt_0b_0mu, "t#bar{t} MC 0-#mu BOX", "t#bar{t} Pred 0-#mu BOX", "RatioPlots/tt_MR_0mu_0b_pred", "MR");
  RatioPlots( tt_0b_0mu_R2, pred_R2_tt_0b_0mu, "t#bat{t} MC 0-#mu BOX", "t#bar{t} Pred 0-#mu BOX", "RatioPlots/tt_R2_0mu_0b_Pred", "RSQ");
  ...
  RatioPlots( W_0b_0mu_MR, pred_MR_W_0b_0mu, "W MC 0-#mu BOX", "W Pred 0-#mu BOX", "RatioPlots/W_MR_0mu_0b_pred", "MR");
  RatioPlots( W_0b_0mu_R2, pred_R2_W_0b_0mu, "W MC 0-#mu BOX", "W Pred 0-#mu BOX", "RatioPlots/W_R2_0mu_0b_Pred", "RSQ");
  ...
  RatioPlots( data_0b_0mu_MR, pred_MR_bkg_0b_0mu, "Data  0-#mu BOX", "Bkg Pred 0-#mu BOX", "RatioPlots/Total_Bkg_MR_0mu_0b_pred_ttSem_tt1muMC", "MR");
  RatioPlots( data_0b_0mu_R2, pred_R2_bkg_0b_0mu, "Data  0-#mu BOX", "BKg Pred 0-#mu BOX", "RatioPlots/Total_Bkg_R2_0mu_0b_Pred_ttSem_tt1muMC", "RSQ");
  //RatioPlots( data_0b_0mu_MR, pred_MR_bkg_0b_0mu, "Data  0-#mu BOX", "Bkg Pred 0-#mu BOX", "RatioPlots/Total_Bkg_MR_0mu_0b_pred_TotMCtt", "MR");
  //RatioPlots( data_0b_0mu_R2, pred_R2_bkg_0b_0mu, "Data  0-#mu BOX", "BKg Pred 0-#mu BOX", "RatioPlots/Total_Bkg_R2_0mu_0b_Pred_TotMCtt", "RSQ");
